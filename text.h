...
pair<SDL_Texture*, SDL_Texture*> createText(SDL_Renderer* ren, TTF_Font* font, const string& text, SDL_Color textColor, SDL_Color outlineColor)
{
 ...
 //  // vien
    ...
    if(res <= 2)
     ...
     case 2:
        ...
        break;
     case 3:
        textRect = {(SCREEN_WIDTH - tw ) / 2, 230, tw + 10, th + 5};
        break;
     case 4:
        textRect = {(SCREEN_WIDTH - tw) / 2, 256, tw + 10, th + 5};
        break;
     default:
